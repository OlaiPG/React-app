[![Quality Gate Status](https://sonarcloud.io/api/project_badges/measure?project=OlaiPG_React-app&metric=alert_status)](https://sonarcloud.io/summary/new_code?id=OlaiPG_React-app)
